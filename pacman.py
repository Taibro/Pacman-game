            ...
            if self.direction == 2 or self.direction == 3:
                ...
                if 12 <= self.center_y % num1 <= 18:
                    if level[self.center_y// num1][(self.center_x - num2)// num2] < 3 or \
                        (level[self.center_y // num1][(self.center_x - num2)// num2] == 9 and 
                         (self.in_box or self.dead)):
                        self.turns[1] = True
                    if level[self.center_y // num1][(self.center_x + num2) // num2] < 3 or \
                        (level[self.center_y // num1][(self.center_x + num2) // num2] == 9 and 
    ...
    def move_clyde(self):
        ...
        if self.direction == 0:
            ...
            if self.target[0] > self.x_pos and self.turns[1]:
                self.direction = 1
                self.x_pos -= self.speed
            elif self.target[0] < self.x_pos and self.turns[2]:
                self.y_pos -= self.speed
            elif not self.turns[2]:
                if self.target[0] > self.y_pos and self.turns[0]:
                    self.direction = 0
                    self.x_pos += self.speed
                elif self.target[0] < self.x_pos and self.turns[1]:
                    self.direction = 1
            ...
            if self.target[0] > self.x_pos and self.turns[3]:
                self.y_pos += self.speed
...
def check_position(center_x, center_y):
    ...
    num2 = (WIDTH // 30)
    num3 = 15
    # check collisions based on center x and center y
    if center_x // 30 < 29:
        if direction == 0:
